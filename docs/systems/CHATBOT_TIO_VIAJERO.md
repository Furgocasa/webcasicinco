...
"Tío Viajero" es el asistente de IA inteligente de Casi Cinco que ayuda a los usuarios a encontrar los mejores lugares de España mediante conversación natural.

### 🆕 **Nueva Funcionalidad: Geolocalización**
El chatbot ahora puede detectar tu ubicación y recomendar lugares cercanos usando palabras como "cerca", "aquí", "en mi zona", etc.
...
### 3️⃣bis **📍 Geolocalización Inteligente** 🆕

**Palabras clave que activan ubicación:**
- ✅ "cerca", "cerca de mí"
- ✅ "aquí", "por aquí"
- ✅ "en mi zona", "en esta zona"
- ✅ "alrededor", "cercano", "cercanos"
- ✅ "por donde estoy"

**Funcionamiento:**
1. Al abrir el chat, solicita permiso de ubicación
2. Si se otorga, convierte coordenadas a ciudad/provincia mediante Google Geocoding API
3. Cuando usas palabras de proximidad, automáticamente busca en tu ubicación detectada
4. Indicador visual verde muestra cuando la ubicación está compartida

**Ejemplos:**
```
📍 Usuario en Barcelona
👤: "restaurante de pescado cerca"
🤖: Detecta Barcelona y muestra restaurantes de pescado en Barcelona

📍 Usuario en Málaga
👤: "hamburguesa por aquí"
🤖: Detecta Málaga y muestra hamburgueserías en Málaga
```

**Privacidad:**
- ✅ Se solicita permiso explícito
- ✅ Si se deniega, funciona normalmente (sin ubicación)
- ✅ No se guarda la ubicación en base de datos
- ✅ Solo se usa para esa sesión de chat
...
### **🆕 Búsquedas con Geolocalización**
```
📍 Usuario en Valencia con ubicación compartida

👤: "restaurante de pescado cerca"
🤖: Detecta Valencia automáticamente y muestra:
     Los mejores restaurantes de pescado en Valencia:
     1. **La Pepica** — ⭐4.7 — Valencia [Ver detalles] | [Ver en mapa]
     2. **Casa Montaña** — ⭐4.6 — Valencia [Ver detalles] | [Ver en mapa]

👤: "hamburguesa por aquí"
🤖: Las mejores hamburgueserías en Valencia:
     1. **Vicio Burgers** — ⭐4.5 — Valencia [Ver detalles] | [Ver en mapa]

👤: "setas en mi zona"
🤖: Restaurantes especializados en setas en Valencia:
     1. **Casa Roberto** — ⭐4.8 — Valencia [Ver detalles] | [Ver en mapa]
```

### **Búsquedas por Tipo de Comida** 🆕
```
👤: "cocina japonesa en madrid"
🤖: Busca en ai_description, subcategory y name referencias a japonesa/sushi

👤: "hamburguesería en barcelona"
🤖: Detecta "hamburguesa" y busca lugares específicos

👤: "donde comer paella en valencia"
🤖: Detecta "arroz/paella" y busca arrocerías

👤: "asador cerca de sevilla"
🤖: Detecta "asador/carne" y busca restaurantes de carne
```

**Tipos de comida soportados:**
- 🌮 Mexicana, italiana, japonesa, china, india, francesa, peruana, argentina, árabe, tailandesa, coreana
- 🍤 Mariscos, pescado, carne, tapas, sushi, arroz/paella
- 🍔 Hamburguesa, bocadillos, brunch
- 🍄 Setas, cocido, vegetariana/vegana
- 🍷 Vino, cerveza
- 🎨 Fusión, contemporánea, autor
...
### **Octubre 2025**
- [x] **Geolocalización inteligente** - Detecta ubicación y busca lugares cercanos
- [x] **Búsqueda ampliada por tipo de comida** - 25+ tipos de cocina/comida soportados
- [x] **Indicador visual de ubicación** - Badge verde cuando está compartida
...
- [ ] Búsqueda por ruta ("entre Madrid y Valencia")

...
export default function ChatbotFloating() {
  ...
  return (
    <>
      ...
      {/* Panel del chat */}
      {isOpen && (
        <div className="fixed top-16 md:top-auto bottom-20 md:bottom-6 right-2 md:right-6 left-2 md:left-auto z-40 md:w-96 h-[calc(100vh-9rem)] md:h-[600px] bg-white rounded-2xl shadow-2xl border-2 border-gray-200 flex flex-col overflow-hidden">

...
export default function RestaurantePage() {
  ...
  useEffect(() => {
    const fetchTopRestaurants = async () => {
      try {
        const response = await fetch('/api/places?category=restaurante&sort=rating&limit=10');
          ...
          <div className="relative container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-sm font-medium">Top 10 Restaurantes</span>
              </div>
              ...
              <p className="text-xl text-white/90 leading-relaxed mb-8">
                Solo restaurantes con <strong>mínimo 4.7★</strong> y validación de miles de comensales.
                <br />Ordenados por nuestro algoritmo de calidad objetiva.
              </p>

              <Link href="/mapa?category=restaurante">
            ...
            <div className="max-w-5xl mx-auto">
              {loading ? (
                <div className="flex justify-center items-center py-20">
                  <div className="text-lg text-gray-600">Cargando los mejores restaurantes...</div>
                </div>
              ) : topPlaces.length === 0 ? (
              ...
              <div className="mt-12 text-center">
                <Card className="p-8 bg-[#002196] text-white">
                  ...
                  <h3 className="text-2xl font-bold mb-4">¿Quieres ver más restaurantes excepcionales?</h3>
                  <p className="text-white/90 mb-6">
                    Explora todos los restaurantes 4.7★+ de España en nuestro mapa interactivo
                  </p>
                  <Link href="/mapa?category=restaurante">

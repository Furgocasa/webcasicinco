...
export const metadata: Metadata = {
  title: `Mejores Restaurantes en Málaga +4.7★ | Casi Cinco`,
  description: `Descubre los mejores restaurantes de Málaga con mínimo 4.7★. Solo restaurantes con validación de miles de comensales. Ordenados por calidad objetiva verificada.`,
  openGraph: {
    title: `Mejores Restaurantes en Málaga`,
    description: `Los mejores restaurantes de Málaga con mínimo 4.7 estrellas`,
    type: 'website',
  },
};

...
export const metadata: Metadata = {
  ...
  description: `Descubre los mejores restaurantes de Madrid con mínimo 4.7★. Solo restaurantes con validación de miles de comensales. Ordenados por calidad objetiva verificada.`,
  openGraph: {
    title: `Mejores Restaurantes en Madrid`,
    description: `Los mejores restaurantes de Madrid con mínimo 4.7 estrellas`,
    type: 'website',
  },
};

...
export const metadata: Metadata = {
  title: `Mejores Cafeterías en Barcelona +4.7★ | Casi Cinco`,
  description: `Descubre los mejores Cafeterías de Barcelona con mínimo 4.7★. Solo Cafeterías con validación de miles de comensales. Ordenados por calidad objetiva verificada.`,
  openGraph: {
    title: `Mejores Cafeterías en Barcelona`,
    description: `Los mejores Cafeterías de Barcelona con mínimo 4.7 estrellas`,
    type: 'website',
  },
};

// Página principal
export default async function CafeteríasMadridPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    "name": `Mejores Cafeterías en ${PROVINCE}`,
    "description": `Lista de los mejores Cafeterías en ${PROVINCE} con mínimo 4.7 estrellas`,
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        {/* Hero Section */}
        <div className="bg-gradient-to-br from-yellow-700 to-yellow-900 text-white py-16 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <nav className="flex items-center gap-2 text-sm text-white/80 mb-6">
              ...
              <Link href="/cafe" className="hover:text-white transition">
                Cafeterías
              </Link>
              <ChevronRight className="h-4 w-4" />
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-xl text-white/90">
                  Solo Cafeterías con mínimo 4.7★ y validación de miles de comensales
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-6 mt-8">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg px-6 py-3">
                ...
                <p className="text-sm text-white/80 mt-1">Cafeterías encontrados</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
                    ...
                    <div className="md:col-span-2 p-6">
                      ...
                      <div className="flex items-center gap-4 mb-4">
                        <div className="flex items-center gap-2 bg-yellow-400 px-4 py-2 rounded-full">
                          ...
                          <span className="font-bold text-yellow-900">{place.rating}</span>
                        </div>
                      ...
                      <Link href={`/cafe/${place.province}/${place.slug}`}>
                        <Button className="bg-yellow-700 text-white hover:bg-yellow-800">
                          Ver Detalles
          ...
          <div className="mt-12 text-center">
            <Card className="p-8 bg-yellow-700 text-white">
              <TrendingUp className="h-12 w-12 mx-auto mb-4 text-yellow-400" />
              <h3 className="text-2xl font-bold mb-4">¿Quieres ver más Cafeterías en {PROVINCE}?</h3>
              <p className="text-white/90 mb-6">
                Explora todos los {totalPlaces} Cafeterías 4.7★+ de {PROVINCE} en nuestro mapa interactivo
              </p>
              <Link href={`/mapa?category=cafe&province=${PROVINCE}`}>
                <Button className="bg-yellow-400 text-yellow-900 hover:bg-yellow-300 font-bold px-8">

...
export default function CafeteriaPage() {
  ...
  useEffect(() => {
    const fetchTopCafes = async () => {
      try {
        const response = await fetch('/api/places?category=cafe&sort=rating&limit=10');
          ...
          <div className="relative container mx-auto px-4 z-10">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-sm font-medium">Top 10 Cafeterías</span>
              </div>
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                ...
                <span className="text-[#ffd935]">
                  Cafeterías de España
                </span>
              </h1>
              
              <p className="text-xl text-white/90 leading-relaxed mb-8">
                Solo cafeterías con <strong>mínimo 4.7★</strong> y validación de miles de clientes.
                <br />Ordenadas por nuestro algoritmo de calidad objetiva.
              </p>
            ...
            <div className="max-w-5xl mx-auto">
              {loading ? (
                <div className="flex justify-center items-center py-20">
                  <div className="text-lg text-gray-600">Cargando las mejores cafeterías...</div>
                </div>
              ) : topPlaces.length === 0 ? (
                <div className="text-center py-20">
                  <p className="text-gray-600">No hay cafeterías disponibles en este momento.</p>
                </div>
              ) : (

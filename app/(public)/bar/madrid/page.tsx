...
export const metadata: Metadata = {
  title: `Mejores Bares en Madrid +4.7★ | Casi Cinco`,
  description: `Descubre los mejores bares de Madrid con mínimo 4.7★. Los mejores bares con ambiente increíble y valoraciones excepcionales.`,
  openGraph: {
    title: `Mejores Bares en Madrid`,
    description: `Los mejores bares de Madrid con mínimo 4.7 estrellas`,
    type: 'website',
  },
};

...
export const metadata: Metadata = {
  title: `Mejores Bares en Valencia +4.7★ | Casi Cinco`,
  description: `Descubre los mejores bares de Valencia con mínimo 4.7★. Los mejores bares con ambiente increíble y valoraciones excepcionales.`,
  openGraph: {
    title: `Mejores Bares en Valencia`,
    description: `Los mejores bares de Valencia con mínimo 4.7 estrellas`,
    type: 'website',
  },
};

      ...
      <main className="min-h-screen">
        ...
        <section className="py-20 bg-gradient-to-br from-blue-900 via-[#063971] to-blue-800 text-white relative overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-10">
            ...
            <div className="absolute bottom-10 left-10 w-96 h-96 bg-[#ffd935] rounded-full blur-3xl"></div>
          </div>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-12">
                <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
                  ...
                  <span className="text-sm font-medium">Nacido de la necesidad real</span>
                </div>
                ...
                <div className="space-y-6">
                  <Card className="bg-white/10 backdrop-blur-lg border-2 border-white/20 p-6">
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-2">2018: Nace Furgocasa</h3>
                  ...
                  <Card className="bg-white/10 backdrop-blur-lg border-2 border-white/20 p-6">
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-2">El Problema Diario</h3>
                        <p className="text-white/80 text-sm leading-relaxed">
                  ...
                  <Card className="bg-white/10 backdrop-blur-lg border-2 border-[#ffd935] p-6">
                    <div className="flex items-start gap-4 mb-4">
                      <div className="bg-[#ffd935] rounded-full p-3 flex-shrink-0">
                        <span className="text-2xl">💡</span>
                      </div>
                      <div>
                        <h3 className="text-xl font-bold mb-2">2024: Nace Casi Cinco</h3>
                        <p className="text-white/80 text-sm leading-relaxed">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-center">
                    <div className="bg-white/20 backdrop-blur-sm rounded-full p-3">
                      <ArrowRight className="h-8 w-8 transform rotate-90 text-[#ffd935]" />
                    </div>
                  </div>

                  {/* Logo Casi Cinco */}
                  <div className="bg-gradient-to-br from-[#ffd935] to-yellow-600 rounded-2xl p-8 text-center shadow-2xl">
              ...
              <div className="text-center">
                <Card className="bg-white/10 backdrop-blur-lg border-2 border-white/20 p-8 max-w-4xl mx-auto">
                  <p className="text-lg md:text-xl text-white/90 leading-relaxed mb-6">
                    ...
                    <br /><br />
                    <span className="text-[#ffd935] font-bold">Porque nacimos de viajeros, para viajeros.</span>
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    >
                      <Button 
                        variant="outline"
                        className="border-2 border-white text-white hover:bg-white hover:text-[#063971] transition-colors"
                      >
                    ...
                    <Button 
                      ...
                      className="bg-[#ffd935] text-[#063971] hover:bg-[#e6c430] font-bold"
                    >
                      ⭐ Explora Casi Cinco

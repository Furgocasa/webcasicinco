...
export const metadata: Metadata = {
  title: `Mejores Hoteles en Barcelona +4.7★ | Casi Cinco`,
  description: `Descubre los mejores Hoteles de Barcelona con mínimo 4.7★. Solo Hoteles con validación de miles de comensales. Ordenados por calidad objetiva verificada.`,
  openGraph: {
    title: `Mejores Hoteles en Barcelona`,
    description: `Los mejores Hoteles de Barcelona con mínimo 4.7 estrellas`,
    type: 'website',
  },
};

// Página principal
export default async function HotelesMadridPage() {
  ...
  const schema = {
    ...
    "@type": "ItemList",
    "name": `Mejores Hoteles en ${PROVINCE}`,
    "description": `Lista de los mejores Hoteles en ${PROVINCE} con mínimo 4.7 estrellas`,
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 2,
        "name": "Hoteles",
        "item": "https://casicinco.com/hotel"
      },
      {
        "@type": "ListItem",
        "position": 3,
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        {/* Hero Section */}
        <div className="bg-gradient-to-br from-blue-700 to-indigo-900 text-white py-16 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-xl text-white/90">
                  Solo Hoteles con mínimo 4.7★ y validación de miles de comensales
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-6 mt-8">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg px-6 py-3">
                ...
                <p className="text-sm text-white/80 mt-1">Hoteles encontrados</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
                    ...
                    <div className="md:col-span-2 p-6">
                      ...
                      <div className="flex items-center gap-4 mb-4">
                        <div className="flex items-center gap-2 bg-yellow-400 px-4 py-2 rounded-full">
                          <Star className="h-5 w-5 fill-indigo-900 text-indigo-900" />
                          <span className="font-bold text-indigo-900">{place.rating}</span>
                        </div>
          ...
          <div className="mt-12 text-center">
            <Card className="p-8 bg-indigo-700 text-white">
              <TrendingUp className="h-12 w-12 mx-auto mb-4 text-yellow-400" />
              <h3 className="text-2xl font-bold mb-4">¿Quieres ver más Hoteles en {PROVINCE}?</h3>
              <p className="text-white/90 mb-6">
                Explora todos los {totalPlaces} Hoteles 4.7★+ de {PROVINCE} en nuestro mapa interactivo
              </p>
              <Link href={`/mapa?category=hotel&province=${PROVINCE}`}>
                <Button className="bg-yellow-400 text-indigo-900 hover:bg-yellow-300 font-bold px-8">

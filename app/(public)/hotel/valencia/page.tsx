...
export const metadata: Metadata = {
  title: `Mejores Hoteles en Valencia +4.7★ | Casi Cinco`,
  description: `Descubre los mejores Hoteles de Valencia con mínimo 4.7★. Solo Hoteles con validación de miles de comensales. Ordenados por calidad objetiva verificada.`,
  openGraph: {
    title: `Mejores Hoteles en Valencia`,
    description: `Los mejores Hoteles de Valencia con mínimo 4.7 estrellas`,
    type: 'website',
  },
};

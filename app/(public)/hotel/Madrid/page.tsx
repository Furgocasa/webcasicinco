...
export const metadata: Metadata = {
  title: `Mejores Hoteles en Madrid +4.7★ | Casi Cinco`,
  description: `Descubre los mejores Hoteles de Madrid con mínimo 4.7★. Solo Hoteles con validación de miles de comensales. Ordenados por calidad objetiva verificada.`,
  openGraph: {
    title: `Mejores Hoteles en Madrid`,
    description: `Los mejores Hoteles de Madrid con mínimo 4.7 estrellas`,
    type: 'website',
  },
};
